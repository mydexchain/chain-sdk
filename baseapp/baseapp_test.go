...
import (
	...
	snapshottypes "github.com/mydexchain/chain-sdk/snapshots/types"
	"github.com/mydexchain/chain-sdk/store/rootmulti"
	store "github.com/mydexchain/chain-sdk/store/types"
...
func registerTestCodec(cdc *codec.LegacyAmino) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "chain-sdk/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "chain-sdk/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "chain-sdk/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgKeyValue{}, "chain-sdk/baseapp/msgKeyValue", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "chain-sdk/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "chain-sdk/baseapp/msgNoDecode", nil)
