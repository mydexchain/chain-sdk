...
// source: dex/slashing/v0/tx.proto
...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "dex.slashing.v0.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "dex.slashing.v0.MsgUnjailResponse")
}

func init() { proto.RegisterFile("dex/slashing/v0/tx.proto", fileDescriptor_3c5611c0c4a59d9d) }
...
var fileDescriptor_3c5611c0c4a59d9d = []byte{
	...
	0x2f, 0xce, 0x49, 0x2c, 0xce, 0xc8, 0xcc, 0x4b, 0xd7, 0x2f, 0x33, 0xd0, 0x2f, 0xa9, 0xd0, 0x2b,
	...
	0xb8, 0xe5, 0x60, 0x06, 0x3a, 0xb9, 0xae, 0x78, 0x24, 0xc7, 0x78, 0xe2, 0x91, 0x1c, 0xe3, 0x85,
	0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0xce, 0x78, 0x2c, 0xc7, 0x10, 0xa5, 0x9f, 0x9e, 0x59,
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x5f, 0x9c, 0x9f, 0x9f, 0x9b, 0x99, 0x97, 0x92,
	0x98, 0xaa, 0x9f, 0x9c, 0x91, 0x98, 0x99, 0xa7, 0x5b, 0x9c, 0x92, 0xad, 0x8f, 0x14, 0x6c, 0x25,
	0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0x00, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x29,
	0xcc, 0x2a, 0xb1, 0x53, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) Unjail(ctx context.Context, in *MsgUnjail, opts ...grpc.CallOption) (*MsgUnjailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dex.slashing.v0.Msg/Unjail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Unjail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dex.slashing.v0.Msg/Unjail",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dex.slashing.v0.Msg",
	...
	Metadata: "dex/slashing/v0/tx.proto",
}
