...
func TestMigrate(t *testing.T) {
	...
	addr1, err := sdk.ConsAddressFromBech32("dxvalcons104cjmxkrg8y8lmrp25de02e4zf00zle4mzs685")
	require.NoError(t, err)
	addr2, err := sdk.ConsAddressFromBech32("dxvalcons10e4c5p6qk0sycy9u6u43t7csmlx9fyadr9yxph")
	require.NoError(t, err)

	gs := v039slashing.GenesisState{
		Params: v039slashing.DefaultParams(),
		SigningInfos: map[string]v039slashing.ValidatorSigningInfo{
			"dxvalcons10e4c5p6qk0sycy9u6u43t7csmlx9fyadr9yxph": {
				Address:             addr2,
				IndexOffset:         615501,
				MissedBlocksCounter: 1,
				Tombstoned:          false,
			},
			"dxvalcons104cjmxkrg8y8lmrp25de02e4zf00zle4mzs685": {
				Address:             addr1,
				IndexOffset:         2,
  ...
  "missed_blocks": [
    {
      "address": "dxvalcons104cjmxkrg8y8lmrp25de02e4zf00zle4mzs685",
      "missed_blocks": [
        {
          "index": "3",
          "missed": true
    ...
    {
      "address": "dxvalcons10e4c5p6qk0sycy9u6u43t7csmlx9fyadr9yxph",
      "missed_blocks": [
        {
          "index": "2",
          "missed": true
