...
func TestMigrate(t *testing.T) {
	...
	recipient, err := sdk.AccAddressFromBech32("cx1fl48vsnmsdzcv85q5d2q4z5ajdha8yu34mf0eh")
	...
	"proposals": [
		...
		{
			"content": {
				"@type": "/dex.distribution.v0.CommunityPoolSpendProposal",
				"amount": [
					{
						"amount": "2",
						"denom": "footoken"
				...
				"description": "bar_community",
				"recipient": "cx1fl48vsnmsdzcv85q5d2q4z5ajdha8yu34mf0eh",
				"title": "foo_community"
			},
			"deposit_end_time": "0001-01-01T00:00:00Z",
			"final_tally_result": {
		...
		{
			"content": {
				"@type": "/dex.upgrade.v0.CancelSoftwareUpgradeProposal",
				"description": "bar_cancel_upgrade",
				"title": "foo_cancel_upgrade"
			},
			"deposit_end_time": "0001-01-01T00:00:00Z",
		...
		{
			"content": {
				"@type": "/dex.upgrade.v0.SoftwareUpgradeProposal",
				"description": "bar_software_upgrade",
				"plan": {
					"height": "123",
					"info": "foo_upgrade_info",
		...
		{
			"content": {
				"@type": "/dex.params.v0.ParameterChangeProposal",
				"changes": [
					{
						"key": "foo_param_change_key",
						"subspace": "foo_param_change_subspace",
