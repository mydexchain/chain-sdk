...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&MsgSubmitProposal{}, "chain-sdk/MsgSubmitProposal", nil)
	cdc.RegisterConcrete(&MsgDeposit{}, "chain-sdk/MsgDeposit", nil)
	cdc.RegisterConcrete(&MsgVote{}, "chain-sdk/MsgVote", nil)
	cdc.RegisterConcrete(&TextProposal{}, "chain-sdk/TextProposal", nil)
}
