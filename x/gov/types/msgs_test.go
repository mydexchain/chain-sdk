...
func TestMsgDepositGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"chain-sdk/MsgDeposit","value":{"amount":[{"amount":"1000","denom":"stake"}],"depositor":"cx1v9jxgu33kfsgr5","proposal_id":"0"}}`
...
func TestMsgSubmitProposal_GetSignBytes(t *testing.T) {
	...
	require.Equal(t,
		`{"type":"chain-sdk/MsgSubmitProposal","value":{"content":{"type":"chain-sdk/TextProposal","value":{"description":"abcd","title":"test"}},"initial_deposit":[]}}`,
		string(bz))
}
