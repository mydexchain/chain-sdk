...
import (
	...
	"github.com/mydexchain/tendermint/proto/tendermint/crypto"
	"github.com/mydexchain/tendermint/rpc/client/http"
	...
	banktestutil "github.com/mydexchain/chain-sdk/x/bank/client/testutil"
...
func (s *IntegrationTestSuite) TestGetCmdQueryValidator() {
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{"dxvaloper15jkng8hytwt22lllv6mw4k89qkqehtahd84ptu", fmt.Sprintf("--%s=json", tmcli.OutputFlag)},
			true,
		},
		{
			"happy case",
...
func (s *IntegrationTestSuite) TestNewCmdRedelegate() {
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				`dxvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj`, // src-validator-addr
				val2.ValAddress.String(),                               // dst-validator-addr
...
// ref: https://github.com/mydexchain/chain-sdk/issues/7401.
