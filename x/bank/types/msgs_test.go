...
func TestMsgSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"chain-sdk/MSgsEnd","value":{"amount":[{"amount":"10","denom":"atom"}],"from_address":"cx1d9h8qat57ljhcm","to_address":"cx1da6hgur4wsmpnjyg"}}`
...
func TestMsgMultiSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"chain-sdk/MSgmUltisEnd","value":{"inputs":[{"address":"cx1d9h8qat57ljhcm","coins":[{"amount":"10","denom":"atom"}]}],"outputs":[{"address":"cx1da6hgur4wsmpnjyg","coins":[{"amount":"10","denom":"atom"}]}]}}`
	require.Equal(t, expected, string(res))
}
