...
func (s *IntegrationTestSuite) TestTotalSupplyGRPCHandler() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/supply", baseURL),
			map[string]string{
		...
		},
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/supply/%s", baseURL, s.cfg.BondDenom),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
		...
		},
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/supply/%s?height=2", baseURL, s.cfg.BondDenom),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			&types.QuerySupplyOfResponse{},
		...
		},
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/supply/foobar", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			&types.QuerySupplyOfResponse{},
...
func (s *IntegrationTestSuite) TestDenomMetadataGRPCHandler() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/denoms_metadata", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			false,
			...
			&types.QueryDenomsMetadataResponse{
				Metadatas: []types.Metadata{
					{
						Description: "The native staking token of the Chain Hub.",
		...
		},
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/denoms_metadata/uatom", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			false,
		...
		},
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/denoms_metadata/foobar", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			true,
...
func (s *IntegrationTestSuite) TestBalancesGRPCHandler() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/balances/%s", baseURL, val.Address.String()),
		...
		},
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/balances/%s/%s", baseURL, val.Address.String(), s.cfg.BondDenom),
		...
		},
		{
			...
			fmt.Sprintf("%s/dex/bank/v0/balances/%s/foobar", baseURL, val.Address.String()),
			&types.QueryBalanceResponse{},
			&types.QueryBalanceResponse{
				Balance: &sdk.Coin{
					Denom:  "foobar",
