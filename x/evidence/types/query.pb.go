...
// source: dex/evidence/v0/query.proto
...
import (
	...
	github_com_tendermint_tendermint_libs_bytes "github.com/mydexchain/tendermint/libs/bytes"
...
type QueryEvidenceRequest struct {
	...
	EvidenceHash github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=evidence_hash,json=evidenceHash,proto3,casttype=github.com/mydexchain/tendermint/libs/bytes.HexBytes" json:"evidence_hash,omitempty"`
}
...
func init() {
	proto.RegisterType((*QueryEvidenceRequest)(nil), "dex.evidence.v0.QueryEvidenceRequest")
	proto.RegisterType((*QueryEvidenceResponse)(nil), "dex.evidence.v0.QueryEvidenceResponse")
	proto.RegisterType((*QueryAllEvidenceRequest)(nil), "dex.evidence.v0.QueryAllEvidenceRequest")
	proto.RegisterType((*QueryAllEvidenceResponse)(nil), "dex.evidence.v0.QueryAllEvidenceResponse")
}

func init() {
	proto.RegisterFile("dex/evidence/v0/query.proto", fileDescriptor_07043de1a84d215a)
}
...
var fileDescriptor_07043de1a84d215a = []byte{
	...
	,
}
...
func (c *queryClient) Evidence(ctx context.Context, in *QueryEvidenceRequest, opts ...grpc.CallOption) (*QueryEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dex.evidence.v0.Query/Evidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllEvidence(ctx context.Context, in *QueryAllEvidenceRequest, opts ...grpc.CallOption) (*QueryAllEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dex.evidence.v0.Query/AllEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Evidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dex.evidence.v0.Query/Evidence",
	}
...
func _Query_AllEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dex.evidence.v0.Query/AllEvidence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dex.evidence.v0.Query",
	...
	Metadata: "dex/evidence/v0/query.proto",
}
