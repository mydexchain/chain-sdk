...
func init() {
	proto.RegisterType((*MsgVerifyInvariant)(nil), "dex.crisis.v0.MsgVerifyInvariant")
	proto.RegisterType((*MsgVerifyInvariantResponse)(nil), "dex.crisis.v0.MsgVerifyInvariantResponse")
}

func init() { proto.RegisterFile("dex/crisis/v0/tx.proto", fileDescriptor_61276163172fe867) }
...
var fileDescriptor_61276163172fe867 = []byte{
	...
	0x4f, 0x2e, 0xca, 0x2c, 0xce, 0x2c, 0xd6, 0x2f, 0x33, 0xd0, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca,
	0x2f, 0xc9, 0x17, 0xe2, 0x4d, 0x49, 0xad, 0xd0, 0x83, 0x88, 0xeb, 0x95, 0x19, 0x48, 0x89, 0xa4,
	...
	0x7a, 0x98, 0x86, 0x48, 0x69, 0x12, 0x54, 0x02, 0xb3, 0xc7, 0xc9, 0xfe, 0xc4, 0x23, 0x39, 0xc6,
	0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf1, 0x58, 0x8e, 0x21, 0x4a, 0x37, 0x3d,
	0xb3, 0x24, 0xa3, 0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0xbf, 0x38, 0x3f, 0x3f, 0x37, 0x33, 0x2f,
	0x25, 0x31, 0x55, 0x3f, 0x39, 0x23, 0x31, 0x33, 0x4f, 0xb7, 0x38, 0x25, 0x5b, 0x1f, 0x1e, 0x8b,
	0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0x18, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff,
	0x51, 0x4b, 0xd9, 0x61, 0xe0, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) VerifyInvariant(ctx context.Context, in *MsgVerifyInvariant, opts ...grpc.CallOption) (*MsgVerifyInvariantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dex.crisis.v0.Msg/VerifyInvariant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_VerifyInvariant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dex.crisis.v0.Msg/VerifyInvariant",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "dex/crisis/v0/tx.proto",
}
