...
func TestGetBroadcastCommand_WithoutOfflineFlag(t *testing.T) {
	...
	from, err := sdk.AccAddressFromBech32("cx1cxlt8kznps92fwu3j6npahx4mjfutydyene2qw")
	require.NoError(t, err)
	to, err := sdk.AccAddressFromBech32("cx1cxlt8kznps92fwu3j6npahx4mjfutydyene2qw")
	require.NoError(t, err)
...
// See https://github.com/mydexchain/chain-sdk/issues/7585 for more details.
