...
import (
	...
	clitestutil "github.com/mydexchain/chain-sdk/testutil/cli"
	...
	authcli "github.com/mydexchain/chain-sdk/x/auth/client/cli"
	authrest "github.com/mydexchain/chain-sdk/x/auth/client/rest"
	authtest "github.com/mydexchain/chain-sdk/x/auth/client/testutil"
	"github.com/mydexchain/chain-sdk/x/auth/legacy/legacytx"
	bankcli "github.com/mydexchain/chain-sdk/x/bank/client/testutil"
	"github.com/mydexchain/chain-sdk/x/bank/types"
	ibccli "github.com/mydexchain/chain-sdk/x/ibc/core/04-channel/client/cli"
	ibcsolomachinecli "github.com/mydexchain/chain-sdk/x/ibc/light-clients/06-solomachine/client/cli"
)
...
// a tx with "chain-sdk/MSgtRansfer" using the SDK, we just hardcode the tx
// here. But external clients might, see https://github.com/mydexchain/chain-sdk/issues/8022.
func mkIBCStdTx() []byte {
	ibcTx := `{
		...
		"msg": [
		  {
			"type": "chain-sdk/MSgtRansfer",
			"value": {
			  "receiver": "cx1q9wtnlwdjrhwtcjmt2uq77jrgx7z3usrq2yz7z",
			  "sender": "cx1q9wtnlwdjrhwtcjmt2uq77jrgx7z3usrq2yz7z",
...
func (s *IntegrationTestSuite) testQueryIBCTx(txRes sdk.TxResponse, cmd *cobra.Command, args []string) {
	...
	grpcJSON, err := rest.GetRequest(fmt.Sprintf("%s/dex/tx/v0/txs/%s", val.APIAddress, txRes.TxHash))
	s.Require().NoError(err)
...
func (s *IntegrationTestSuite) TestLegacyRestErrMessages() {
	...
	consensusJSON := testutil.WriteToNewTempFile(
		s.T(),
		`{"public_key":{"@type":"/dex.crypto.secp256k1.PubKey","key":"A/3SXL2ONYaOkxpdR5P8tHTlSlPv1AwQwSFxKRee5JQW"},"diversifier":"diversifier","timestamp":"10"}`,
	)
...
// ref: https://github.com/mydexchain/chain-sdk/issues/8679
