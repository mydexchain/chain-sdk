...
import (
	...
	clientrest "github.com/mydexchain/chain-sdk/client/rest"
	...
	genutilrest "github.com/mydexchain/chain-sdk/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/mydexchain/chain-sdk/issues/4923
...
func QueryTxsRequestHandlerFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = checkAminoMarshalError(clientCtx, searchResult, "/dex/tx/v0/txs")
		if err != nil {
			rest.WriteErrorResponse(w, http.StatusInternalServerError, err.Error())
...
func QueryTxRequestHandlerFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = checkAminoMarshalError(clientCtx, output, "/dex/tx/v0/txs/{txhash}")
		if err != nil {
			rest.WriteErrorResponse(w, http.StatusInternalServerError, err.Error())
