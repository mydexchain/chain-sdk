...
import (
	...
	v034 "github.com/mydexchain/chain-sdk/x/auth/legacy/v034"
...
func TestMigrate(t *testing.T) {
  ...
  "accounts": [
    {
      "@type": "/dex.auth.v0.BaseAccount",
      "account_number": "1",
      "address": "cx13syh7de9xndv9wmklccpfvc0d8dcyvay4s6z6l",
      "pub_key": {
        "@type": "/dex.crypto.secp256k1.PubKey",
        "key": "A8oWyJkohwy8XZ0Df92jFMBTtTPMvYJplYIrlEHTKPYk"
      },
      "sequence": "0"
    },
    {
      "@type": "/dex.auth.v0.ModuleAccount",
      "base_account": {
        "account_number": "1",
        "address": "cx1v57fx2l2rt6ehujuu99u2fw05779m5e2ux4z2h",
        "pub_key": {
          "@type": "/dex.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/dex.vesting.v0.BaseVestingAccount",
      "base_account": {
        "account_number": "1",
        "address": "cx18hnp9fjflrkeeqn4gmhjhzljusxzmjeartdckw",
        "pub_key": {
          "@type": "/dex.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/dex.vesting.v0.ContinuousVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
          "address": "cx1t9kvvejvk6hjtddx6antck39s206csqduq3ke3",
          "pub_key": {
            "@type": "/dex.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/dex.vesting.v0.PeriodicVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
          "address": "cx1s4ss9zquz7skvguechzlk3na635jdrecl0sgy2",
          "pub_key": {
            "@type": "/dex.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/dex.vesting.v0.DelayedVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
          "address": "cx1mcc6rwrj4hswf8p9ct82c7lmf77w9tuk07rha4",
          "pub_key": {
            "@type": "/dex.crypto.secp256k1.PubKey",
    ...
    },
    {
      "@type": "/dex.auth.v0.BaseAccount",
      "account_number": "1",
      "address": "cx16ydaqh0fcnh4qt7a3jme4mmztm2qel5axcpw00",
      "pub_key": null,
      "sequence": "0"
    }
  ],
