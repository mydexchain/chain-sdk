...
import (
	...
	types "github.com/mydexchain/chain-sdk/x/ibc/core/02-client/types"
	types1 "github.com/mydexchain/chain-sdk/x/ibc/core/23-commitment/types"
	...
	types2 "github.com/mydexchain/tendermint/proto/tendermint/types"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type ConsensusState struct {
	...
	NextValidatorsHash github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,3,opt,name=next_validators_hash,json=nextValidatorsHash,proto3,casttype=github.com/mydexchain/tendermint/libs/bytes.HexBytes" json:"next_validators_hash,omitempty" yaml:"next_validators_hash"`
}
