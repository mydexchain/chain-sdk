...
import (
	...
	"github.com/mydexchain/chain-sdk/x/ibc/light-clients/06-solomachine/types"
)
...
func NewCreateClientCmd() *cobra.Command {
	...
	- ConsensusState json example: {"public_key":{"@type":"/dex.crypto.secp256k1.PubKey","key":"A/3SXL2ONYaOkxpdR5P8tHTlSlPv1AwQwSFxKRee5JQW"},"diversifier":"diversifier","timestamp":"10"}`,
