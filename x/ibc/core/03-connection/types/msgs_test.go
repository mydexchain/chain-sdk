...
import (
	...
	"github.com/mydexchain/chain-sdk/x/ibc/core/03-connection/types"
	...
	ibctesting "github.com/mydexchain/chain-sdk/x/ibc/testing"
)
...
func (suite *MsgTestSuite) TestNewMsgConnectionOpenInit() {
	...
	signer, _ := sdk.AccAddressFromBech32("cx1ckgw5d7jfj7wwxjzs9fdrdev9vc8dzcw3n2lht")
