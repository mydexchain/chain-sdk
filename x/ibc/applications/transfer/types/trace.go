...
//  - A valid fungible token representation (i.e 'ibc/{hash}') per ADR 001 https://github.com/mydexchain/chain-sdk/blob/master/docs/architecture/adr-001-coin-source-tracing.md
