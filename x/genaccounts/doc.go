...
The ADR can be found here: https://github.com/mydexchain/chain-sdk/blob/master/docs/architecture/adr-011-generalize-genesis-accounts.md.
...
refer to https://github.com/mydexchain/gaia/pull/122.
*/
package genaccounts
