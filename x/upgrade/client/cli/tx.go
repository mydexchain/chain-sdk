...
import (
	...
	gov "github.com/mydexchain/chain-sdk/x/gov/types"
	"github.com/mydexchain/chain-sdk/x/upgrade/types"
)
...
func NewCmdSubmitUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/mydexchain/chain-sdk/tree/master/cosmovisor",
