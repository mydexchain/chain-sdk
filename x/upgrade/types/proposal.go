...
func init() {
	...
	gov.RegisterProposalTypeCodec(&SoftwareUpgradeProposal{}, "chain-sdk/SOftwareuPgradepRoposal")
	gov.RegisterProposalType(ProposalTypeCancelSoftwareUpgrade)
	gov.RegisterProposalTypeCodec(&CancelSoftwareUpgradeProposal{}, "chain-sdk/CAncelsOftwareuPgradepRoposal")
}
