...
import (
	...
	"github.com/mydexchain/chain-sdk/types/bech32"
)
...
const (
	...
	// CoinType is the DXC coin type as defined in SLIP44 (https://github.com/satoshilabs/slips/blob/master/slip-0044.md)
	CoinType = 118

	// FullFundraiserPath is the parts of the BIP44 HD path that are fixed by
	// what we used during the DXC fundraiser.
...
// TODO: Remove Bech32ifyPubKey and all usages (soomindae/chain-sdk/issues/#7357)
