...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/mydexchain/chain-sdk/types/errors.Wrap",
		"github.com/mydexchain/chain-sdk/types/errors.Wrapf",
		"github.com/mydexchain/chain-sdk/types/errors.WithType",
