...
func TestBaseReq_Sanitize(t *testing.T) {
	...
	sanitized := rest.BaseReq{ChainID: "   test",
		Memo:          "memo     ",
		From:          " cx1cq0sxam6x4l0sv9yz3a2vlqhdhvt2k6jtgcse0 ",
		Gas:           " ",
		GasAdjustment: "  0.3",
	}.Sanitize()
...
func TestBaseReq_ValidateBasic(t *testing.T) {
	fromAddr := "cx1cq0sxam6x4l0sv9yz3a2vlqhdhvt2k6jtgcse0"
...
func TestProcessPostResponse(t *testing.T) {
	...
	cdc.RegisterConcrete(&mockAccount{}, "chain-sdk/mockAccount", nil)
