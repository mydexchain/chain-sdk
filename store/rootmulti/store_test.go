...
import (
	...
	sdkmaps "github.com/mydexchain/chain-sdk/store/internal/maps"
...
func benchmarkMultistoreSnapshot(b *testing.B, stores uint8, storeKeys uint64) {
	b.Skip("Noisy with slow setup time, please see https://github.com/mydexchain/chain-sdk/issues/8855.")
