...
import (
	...
	"github.com/mydexchain/chain-sdk/codec/legacy"
	"github.com/mydexchain/chain-sdk/crypto/hd"
	"github.com/mydexchain/chain-sdk/crypto/types"
...
func TestPublicKeyUnsafe(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "dxpub1addwnpepqd87l8xhcnrrtzxnkql7k55ph8fr9jarf4hn6udwukfprlalu8lgw0urza0",
		pubKeyAddr, "Is your device using test mnemonic: %s ?", testutil.TestMnemonic)

	addr := sdk.AccAddress(priv.PubKey().Address()).String()
	require.Equal(t, "cx1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
		addr, "Is your device using test mnemonic: %s ?", testutil.TestMnemonic)
}

func TestPublicKeyUnsafeHDPath(t *testing.T) {
	expectedAnswers := []string{
		"dxpub1addwnpepqd87l8xhcnrrtzxnkql7k55ph8fr9jarf4hn6udwukfprlalu8lgw0urza0",
		"dxpub1addwnpepqfsdqjr68h7wjg5wacksmqaypasnra232fkgu5sxdlnlu8j22ztxvlqvd65",
		"dxpub1addwnpepqw3xwqun6q43vtgw6p4qspq7srvxhcmvq4jrx5j5ma6xy3r7k6dtxmrkh3d",
		"dxpub1addwnpepqvez9lrp09g8w7gkv42y4yr5p6826cu28ydrhrujv862yf4njmqyyjr4pjs",
		"dxpub1addwnpepq06hw3enfrtmq8n67teytcmtnrgcr0yntmyt25kdukfjkerdc7lqg32rcz7",
		"dxpub1addwnpepqg3trf2gd0s2940nckrxherwqhgmm6xd5h4pcnrh4x7y35h6yafmcpk5qns",
		"dxpub1addwnpepqdm6rjpx6wsref8wjn7ym6ntejet430j4szpngfgc20caz83lu545vuv8hp",
		"dxpub1addwnpepqvdhtjzy2wf44dm03jxsketxc07vzqwvt3vawqqtljgsr9s7jvydjmt66ew",
		"dxpub1addwnpepqwystfpyxwcava7v3t7ndps5xzu6s553wxcxzmmnxevlzvwrlqpzz695nw9",
		"dxpub1addwnpepqw970u6gjqkccg9u3rfj99857wupj2z9fqfzy2w7e5dd7xn7kzzgkgqch0r",
	}
...
func TestPublicKeySafe(t *testing.T) {
	path := *hd.NewFundraiserParams(0, sdk.CoinType, 0)
	priv, addr, err := NewPrivKeySecp256k1(path, "dex")
...
func TestPublicKeyHDPath(t *testing.T) {
	...
	expectedAddrs := []string{
		"cx1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
		"cx19ewxwemt6uahejvwf44u7dh6tq859tkyvarh2q",
		"cx1a07dzdjgjsntxpp75zg7cgatgq0udh3pcdcxm3",
		"cx1qvw52lmn9gpvem8welghrkc52m3zczyhlqjsl7",
		"cx17m78ka80fqkkw2c4ww0v4xm5nsu2drgrlm8mn2",
		"cx1ferh9ll9c452d2p8k2v7heq084guygkn43up9e",
		"cx10vf3sxmjg96rqq36axcphzfsl74dsntuehjlw5",
		"cx1cq83av8cmnar79h0rg7duh9gnr7wkh228a7fxg",
		"cx1dszhfrt226jy5rsre7e48vw9tgwe90uerfyefa",
		"cx1734d7qsylzrdt05muhqqtpd90j8mp4y6rzch8l",
	}
