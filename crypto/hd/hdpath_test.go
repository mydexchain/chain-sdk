...
// See issue https://github.com/mydexchain/chain-sdk/issues/7627.
...
func ExampleSomeBIP32TestVecs() {
	...
	master, ch := hd.ComputeMastersFromSeed(seed)
	fmt.Println("keys from fundraiser test-vector (dex, bitcoin, ether)")
	fmt.Println()
	// chain
	...
	// Output: keys from fundraiser test-vector (dex, bitcoin, ether)
	//
...
// See issue https://github.com/mydexchain/chain-sdk/issues/8557.
