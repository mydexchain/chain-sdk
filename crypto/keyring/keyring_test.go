...
import (
	...
	"github.com/mydexchain/chain-sdk/crypto"
...
func TestNewKeyring(t *testing.T) {
	...
	kr, err := New("dex", BackendFile, dir, mockIn)
	require.NoError(t, err)

	nilKr, err := New("dex", "fuzzy", dir, mockIn)
	require.Error(t, err)
	require.Nil(t, nilKr)
...
func TestKeyManagementKeyRing(t *testing.T) {
	...
	require.NoError(t, err)
	addr, err := sdk.AccAddressFromBech32("cx1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t")
	require.NoError(t, err)
